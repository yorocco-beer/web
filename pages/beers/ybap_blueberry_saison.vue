...
export default defineComponent({
  head: {
    title: 'Yorocco Beer : Y/B/A/P #001 Y/B/A/P #001 Blueberry Saison',
    meta: [
      {
        hid: 'og:url',
        property: 'og:url',
        content: `${process.env.BASE_URL}/beers/ybap_blueberry_saison/`,
      },
      {
        hid: 'og:title',
        property: 'og:title',
        content: 'Yorocco Beer : Y/B/A/P #001 Y/B/A/P #001 Blueberry Saison',
      },
      ...
      { hid: 'og:description', property: 'og:description', content: '' },
      {
        hid: 'og:image',
        property: 'og:image',
        content: `${process.env.BASE_URL}/ogp/1.jpg`,
      },
      {
        hid: 'twitter:card',
        name: 'twitter:card',
