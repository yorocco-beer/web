  ...
  <div id="main-wrapper">
    ...
    <div class="single-product-wrap">
      ...
      <div class="c-beer__content">
        ...
        <dl>
          <dt>2021.6.19</dt>
          <dd>仕込み。箕面ビールとのコラボビール「Plumbon Saison」</dd>
          <dt>2021.7.14</dt>
          <dd>
        ...
        <p class="note">※ その後瓶内発酵・熟成</p>

        <h1>TASTING NOTES</h1>
        <p>明るい金色の外観。甘い香り。杏仁。柔らかい酸味。ミネラル感。</p>
...
export default defineComponent({
  head: {
    title: 'ヨロッコビール / Yorocco Beer : Y/B/A/P #0012 SUMOMO 2021',
    meta: [
      {
        hid: 'og:url',
        property: 'og:url',
        content: `${process.env.BASE_URL}/beers/ybap_sumomo_2021/`,
      },
      {
        hid: 'og:title',
        property: 'og:title',
        content: 'ヨロッコビール / Yorocco Beer : Y/B/A/P #0012 SUMOMO 2021',
      },
      ...
      { hid: 'og:description', property: 'og:description', content: '' },
      {
        hid: 'og:image',
        property: 'og:image',
        content: `${process.env.BASE_URL}/ogp/12.jpg`,
      },
      {
        hid: 'twitter:card',
        name: 'twitter:card',
